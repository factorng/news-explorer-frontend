...
}) 
{
  ...
  let buttonClassName = `${
    pathname === "/saved-news"
      ...
      : currentUser.name
      ? `${bookmarkMarked ? 'news-card__button-bookmark_loggedIn news-card__button-bookmark_marked' : 'news-card__button-bookmark_loggedIn'}`
  ...
  return (
    <div className="news-card">
      ...
      <img className="news-card__image" src={article.urlToImage || article.image} alt={article.title}></img>
      <div className="news-card__info">
        <p className="news-card__date">{dateFormat(article.publishedAt || article.date)}</p>
